...
if on_nersc:  
  ...
  VI_dir = os.environ['HOME']+'/projects/VI_files/Fuji/BGS/'
else:
...
subset = "BGS"  # YOU WANT TO CHANGE THIS EACH TIME, it defines "pattern" below.  Set to "" to use all.
output_name = "desi-vi_BGS_quality_LEQ_25_revisit_"+id[0]+'_merged'
